...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <!-- <li><a href="lihat_trip.php">Lihat Perjalanan</a></li> --> <!--belum saatnya, cuman biar ga lupa aja :v -->
    ...
    <div id="popup" class="hidden">
        <div class="popup-content">
            ...
            <form id="planning-form" action="process.php" method="POST" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" placeholder="opsional"></textarea>
                </div>
                <div>
                ...
                <div>
                    <label for="file_upload">Upload Foto (Max 2MB):</label>
